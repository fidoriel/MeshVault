    ...
    <div className="max-w-6xl mx-auto p-6">
      <div className="prose max-w-none">
        ...
        <p className="text-gray-700 mb-4">
          This is a detailed description of the 3D model. It includes
          information about its features, use cases, and any special
          instructions for printing or assembly. The description helps users
